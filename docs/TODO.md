...
- 2. Design Tokens Layer  
  ...
  - [x] [ds9-3 · 2.2 Extract Theme Variant Rules](#22-ds9-3-extract-theme-variant-rules)  
  - [x] [ds9-4 · 2.3 Define Public Tokens API Contract](#23-ds9-4-define-public-tokens-api-contract)  
...
- 4. Core Component Primitives (CSS‑First)  
  ...
  - [x] [ds9-11 · 4.4 Extract Tile Primitive](#44-ds9-11-extract-tile-primitive)  
    - depends on: ds9-2, ds9-5  
  - [x] [ds9-12 · 4.5 Extract Breadcrumb Primitive](#45-ds9-12-extract-breadcrumb-primitive)  
    - depends on: ds9-2, ds9-8  
