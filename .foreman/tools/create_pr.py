...
def main() -> None:
  ...
  parser.add_argument("--worktree", required=True, help="Path to git worktree for this task")
  parser.add_argument("--branch", required=True, help="Local branch name for this task")
